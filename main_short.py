...
with contextlib.ExitStack() as stack:
    ...
    for deviceInfo in DEVICE_INFOS:
        ...
        samplers, warp_nodes, analyzers = deviceAnalyzer(node_out, shared_ticker, sample_interval_seconds = SAMPLE, threshold_multiplier = 1.5, visualizer = visualizer, device = device, debug = DEBUG)
