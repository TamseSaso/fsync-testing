...
with contextlib.ExitStack() as stack:
    ...
    shared_ticker = SharedTicker(period_sec=2.0, start_delay_sec=0.0)
    ...
    for deviceInfo in DEVICE_INFOS:
        ...
        sampler = FrameSamplingNode(sample_interval_seconds=5.0, shared_ticker=shared_ticker, emit_first_frame_immediately=True).build(node_out)
